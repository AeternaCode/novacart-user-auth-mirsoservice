...
public interface IUsers {
    ApiResponse<PageResponse<GetUserResponseDTO>> getAllUsers(int pageNumber, int size, UserSortField sortBy, SortDirection sortDirection);
    ...
    ApiResponse<PageResponse<GetDeletedUserResponseDTO>> getDeletedUsers(int pageNumber, int size, UserSortField sortBy, SortDirection sortDirection);
